...
public class customer {
    ...
    public String printticket(String platenumber){
    ...
    public double pay(int ticketid,String platenumber) throws ParseException{
        ...
        if(checkspotid>0){
            ...
            double cost = 5 * eo.parkingHours(ticketid);/*this function to return the differant between enter and exit time and multiplay it with the cost*/
